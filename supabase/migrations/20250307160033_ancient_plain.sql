...
-- Create function to set order number before insert
...
-- Create order_items table with notes field
...
CREATE POLICY "enable_insert_for_order_items"
...
CREATE POLICY "enable_select_for_order_items"
